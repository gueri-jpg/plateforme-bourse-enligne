// ============================================================================
// screens/WatchlistScreen.tsx — Liste des valeurs en favoris
// Adapté de app/(tabs)/watchlist.tsx pour React Navigation
...
export function WatchlistScreen() {
  ...
  // Recharger la watchlist à chaque fois que l'écran prend le focus
    ...
    <View style={s.card}>
      ...
      <View style={s.actions}>
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('Ordre', { stock: item.name, direction: 'achat' })}
        >
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('Ordre', { stock: item.name, direction: 'vente' })}
        >
        ...
        ListEmptyComponent={
          <View style={s.empty}>
            ...
            <Text style={s.emptyHint}>
              Appuyez sur ☆ dans l'onglet Marché pour ajouter des valeurs à suivre.
            </Text>
          </View>
        }
      />
