<#-- error.ftl â€” CFBourse â€” page d'erreur -->
<!DOCTYPE html>
<html lang="fr">
<head>
  <meta charset="UTF-8">
...
<div class="bourse-page">
  <div class="bourse-card">
    ...
    <div class="bourse-info-body">
      <span class="bourse-info-icon" aria-hidden="true">ðŸ”’</span>

      <h1 class="bourse-info-title">AccÃ¨s refusÃ©</h1>

      <#if message?has_content>
        <div class="kc-alert error" role="alert" style="text-align:left; max-width:360px; margin:0 auto 20px;">
          <span class="kc-alert-icon">âœ•</span>
